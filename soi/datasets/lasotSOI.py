...
class LaSOT_SOI(object):
    ...
    def __init__(self, root_dir, subset='test', return_meta=False, mode='MaxPooling', th=0.1):
        ...
        split_file = os.path.join('/mnt/second/wangyipei/SOI/data/lasot', subset[0], 'mine_result', 'org.json')  # mode+'th_{}'.format(th)  'lasot_%s_info.json' % subset[0]
        # /mnt/second/wangyipei/SOI/data/lasot/test/candidates_th0.6/lasot_test_info.json
