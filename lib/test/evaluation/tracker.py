...
import numpy as np
import torch
from soi.utils.screening_util import find_local_maxima_v1, mask_image_with_boxes, iou4list, mask_image_with_boxes_online
import json
...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
        ...
        if self.run_soi == 3:  # step 3 run soi online
            ...
            self.last_soi_info = {"frame_id": 1, "status": "right", "track_iou_gt": [], "gt_coord": None, "mask_boxes": []}
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        if self.run_soi == 3:  # TODO 可视化热力图结果  {"frame_id": frame_id, "status": status, "track_iou_gt": track_iou_gt, "gt_coord": gt_coord, "mask_boxes": mask_boxes}
            ...
            # output['tg_num'] = []
            # output['candidate_boxes'] = []  x1': 332, 'y1': 166, 'x2': 382, 'y2': 181  'x1': 335, 'y1': 171, 'x2': 386, 'y2': 187  [334.963228225708, 169.2424807548523, 50.96104049682617, 15.92464542388916]
            if 0:
                output['search_img'] = []
        ...
        for frame_num, frame_path in enumerate(seq.frames[1:], start=1):
            ...
            if self.run_soi == 2:  # step 2 run online with masked image
                ...
                image = mask_image_with_boxes_online(image, self.last_soi_info['mask_boxes'], self.last_soi_info['gt_coord'], debug_save_path=debug_save_path)
